...
_systemcall_table_init
		...
		; add your code here
		LDR		r2, =_sys_malloc		; may have to use other register beside r1
		STR		r2, [r0, #4]!
	
		; Initialize_SYSTEMCALLTBL[2] = _sys_free
		; add your code here
		LDR		r3, =_sys_free		; may have to use other register beside r1
		STR		r3, [r0, #4]
...
_systemcall_table_jump
		...
		CMP		r10, #0x1			; switch statement to determind 
		BLT		_sys_exit			; which function to call
		BEQ		_sys_malloc
		BGT		_sys_free
